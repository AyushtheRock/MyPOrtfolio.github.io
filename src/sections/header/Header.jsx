...
import './header.css'
import HeadedImage from '../../assests/Ayush.jpg'
   ...
   <header id='header'> 
    <div className="container header__container">
      <div className="header__profile">
        <img src={HeadedImage} alt="" />
      </div>
      <h3>Ayush Chaurasia</h3>
      <p>You are a click away from building your dream website or web app. Send me 
